# Quick Start Guide - Act 1

## 🎮 How to Play in 60 Seconds

1. **Open the game**: Double-click `index.html` or open it in your browser
2. **Read Dr. Elena's story** on the left side
3. **Drag components** from the palette to the blue grid
4. **Click "Check My Model"** when ready
5. **Need help?** Click "Get Hint" for AI assistance
...
**Typical play time**: 5-10 minutes
...
- **Cell Collective Colors**: Blue (#00d4ff) and dark backgrounds
- **Smooth Animations**: Components fade in, badges glow
- **Visual Feedback**: Hover effects, shadows, state indicators
- **Progress Tracking**: Badges show completed fundamentals
...
- **Tablet**: Works well ✅
- **Mobile**: Basic support (optimized in Act 2) ⚠️
...
- **Attempts**: Times you clicked "Check My Model"
- **Hints Used**: Number of times you asked the AI for help
- **Fundamentals Mastered**: Which of 3 fundamentals you completed (1-3)

Lower attempts and fewer hints = better mastery!
...
**Coming in Act 2**: Boolean logic, feedback loops, and simulations!

**Coming in Act 3**: Model refinement, communication, and understanding limitations!

---

**Need Help?** The AI is always there - just click "Get Hint"! Dr. Elena wants you to succeed! 👩‍🔬
