...
An interactive educational game that teaches the 10 fundamentals of Boolean modeling through an engaging choose-your-own-adventure story with Dr. Maya, a brilliant scientist investigating mysterious cell mutations.
...
4. Logic Functions (AND/OR/NOT gates)
5. State Space
6. Feedback Loops
7. Predicting System Behavior
8. Perturbations & Testing
9. Bistability & Switches
10. Validation & Iteration

## 🎯 Target Audience

Middle school students (ages 11-14) - approximately 10-15 minutes of gameplay.
...
- Cyan/teal colored shirt
- White lab coat with ModelIt! patch
...
**Ready to solve the mystery? Open `modelit-story.html` and start your adventure with Dr. Maya! 🔬**
