                ...
                options: [
                    {
                        ...
                        next: 4,
                        gameOver: true,
                        feedback: "WRONG! ❌ The Enzyme needs BOTH Signal AND Receptor to be ON (remember the AND gate from earlier?). Just having the Receptor ON isn't enough. The cells have mutated catastrophically because of this miscalculation!"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        next: 4,
                        gameOver: true,
                        feedback: "WRONG! ❌ Any combination of ON/OFF states is valid! The system won't crash - but you need to predict what happens. The cells have spread out of control because we couldn't predict the behavior!"
                    }
                ]
            }
        },
                ...
                options: [
                    {
                        ...
                        next: 7,
                        gameOver: true,
                        feedback: "WRONG! ❌ This is NEGATIVE feedback (Enzyme INHIBITS Receptor)! Positive feedback would amplify, but negative feedback creates oscillations or stability. The cells have spiraled out of control because we misunderstood the dynamics!"
                    },
                    {
                        text: "It's NEGATIVE feedback - it will create oscillations or stabilize the system",
                        next: 7,
                        feedback: "CORRECT! ✅ Excellent! Negative feedback (Enzyme inhibits Receptor) creates self-regulation - the system will pulse ON and OFF rhythmically, or settle into a stable state! This is how biological clocks and thermostats work!"
                    },
                    {
                        text: "Feedback loops don't matter - only the initial state matters",
                        next: 7,
                        gameOver: true,
                        feedback: "WRONG! ❌ Feedback loops COMPLETELY change system behavior! They can create oscillations, bistability, or chaos! Ignoring the feedback loop has led to catastrophic cell mutation!"
                    }
                ]
            }
        },
                ...
                options: [
                    {
                        ...
                        next: 8,
                        feedback: "Excellent experimental design! Testing different perturbations helps us understand the system better!"
                    },
                    {
                        text: "What if we increase the signal instead? See what breaks?",
                        next: 8,
                        feedback: "Interesting approach! Stress-testing the system can reveal its limits. Let's try both!"
                    }
                ]
            }
        },
                ...
                options: [
                    {
                        ...
                        next: 9,
                        feedback: "YES! Model validation is crucial. Let's compare predictions to reality!"
                    },
                    {
                        text: "Build a completely new model from scratch",
                        next: 9,
                        feedback: "We could, but it's better to VALIDATE first. If our model matches reality, we can REFINE it rather than restart!"
                    }
                ]
            }
        },
                ...
                options: [
                    {
                        ...
                        next: 10,
                        gameOver: true,
                        feedback: "WRONG! ❌ Stable oscillations indicate negative feedback controlling the system! With BOTH positive AND negative feedback together, we'd see bistability or chaotic switching, not stable rhythms! The cells have exploded across the entire facility!"
                    },
                    {
                        text: "The system shows bistability - it can lock into either a high state OR low state",
                        next: 10,
                        feedback: "CORRECT! ✅ BRILLIANT! When positive and negative feedback coexist, you get BISTABILITY - the system can be trapped in either an ON state or OFF state, like a toggle switch! This is how cell differentiation and decision-making works! You just saved the day!"
                    },
                    {
                        text: "The system always returns to the exact same equilibrium point",
                        next: 10,
                        gameOver: true,
                        feedback: "WRONG! ❌ A single equilibrium point indicates pure negative feedback! With BOTH positive and negative feedback, you get MULTIPLE stable states (bistability)! Your miscalculation has caused a biohazard emergency!"
                    }
                ]
            }
        },
